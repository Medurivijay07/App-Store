...
class AppStore extends Component {
  ...
  changeTab = tabId => {
    const newActiveTab = tabsList.find(eachItem => eachItem.tabId === tabId)
    this.setState({activeTabId: newActiveTab.tabId})
  }
  ...
  render() {
    ...
    const filteredSearchApps = filteredApps.filter(eachItem =>
    ...
    return (
      <div className="main-container">
        ...
        <ul className="apps-list">
          {filteredSearchApps.map(eachItem => (
